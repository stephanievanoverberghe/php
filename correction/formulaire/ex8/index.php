...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $typeMime = $_FILES['cvFile']['type'];
    if ($typeMime != 'application/pdf') {
        $errorExtension = 'Le format du fichier n\'est pas bon!';
    }
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-6">
                ...
                <?php
                if ($_SERVER['REQUEST_METHOD'] != 'POST' || empty($lastname) || isset($errorExtension)) {
                ?>
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input value="<?= $lastname ?? '' ?>" name="lastname" class="form-control form-control-lg" type="text" placeholder="Entrez votre nom" id="lastname" required>
                            <?= $errorLastname ?? '' ?>
                        </div>
